...
namespace ASSETManagement.Controllers
{
    public class AppliancesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ApplianceID,ApplianceType,price")] Appliance appliance)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ApplianceID,ApplianceType,price")] Appliance appliance)
        {
            if (ModelState.IsValid)
            {
